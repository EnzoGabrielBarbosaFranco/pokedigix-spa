            ...
            <table class="table table-light">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">Nome do Treinador:</th>
                        ...
                        <th scope="col" class="text-center">Região:</th>
                        <th scope="col" class="text-center">Dinheiro:</th>
                        <th scope="col" class="text-center">Insígnias:</th> -->
                ...
                <tbody>
                    <tr v-for="treinador in treinadores" :key="treinador.id">
                        <th scope="row" class="text-center">{{treinador.id}}</th>
