...
<template>
    <div class="row">
        <h2 class="mb-4 mt-4 text-center">Lista de Tipos:</h2>
            ...
            <table class="table table-light">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">Nome do Tipo:</th>
                ...
                <tbody>
                    <tr v-for="tipo in tipos" :key="tipo.id">
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-outline-secondary" @click="editar(tipo.id)">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Você está apagando o tipo "<strong> {{tipoSelecionado.nome}} </strong>". Deseja continuar?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" @click="removerTipoSelecionado"
