...
<template>
    <div v-if="!salvo">
        <form>
            <h4 class="mt-4 mb-2 text-center"> Cadastro de Treinadores:</h4>
            <div class="mb-3">
                <label for="nome" class="form-label mt-3">Nome do Treinador: </label>
                <input type="text" required class="form-control" v-model="treinadorRequest.nome" id="nome" />
            </div>
            <label for="pokemon" class="form-label">Pokémon inicial: </label>
            ...
            <button @click.prevent="salvar" class="btn btn-success mt-3 mb-3 col-12">Salvar</button>
        </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="enderecoModalLabel">Cadastro de Endereço:</h1>
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <label for="regiao" class="form-label mt-3">Região: </label>
                            <input type="text" required class="form-control" v-model="endereco.regiao" id="regiao" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" @click.prevent="salvarEndereco"
                                data-bs-dismiss="modal">Salvar</button>
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                @click.prevent="cancelar">Cancelar</button>
                        </div>
                    </form>
                </div>
            </div>
