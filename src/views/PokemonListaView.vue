...
<template>
  <main>
    <div>
              ...
              <div class="col-md-9">
                <div class="card-body">
                  ...
                  <div class="text-center">
                    <button type="button" class="btn btn-outline-primary pt-1 m-1 " data-bs-toggle="collapse" :data-bs-target="'#collapseExample' + pokemon.id">
                      Detalhes
      ...
      <button type="button"
        class="btn btn-primary pt-1 m-1">
